...
var msal_1 = require("@azure/msal");
function tryLogin() {
    return __awaiter(this, void 0, void 0, function () {
        var config, params, myMSAL, login, error_1, login;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    myMSAL = new msal_1.UserAgentApplication(config);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 6]);
                    return [4 /*yield*/, myMSAL.acquireTokenSilent(params)];
                case 2:
                    login = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    return [4 /*yield*/, myMSAL.loginPopup(params)];
                case 4:
                    _a.sent();
